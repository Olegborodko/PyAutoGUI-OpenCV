...
def paste_text():
    """Вставляє текст з буфера обміну. Повертає True у разі успіху"""
    try:
        print("📋 Вставляю текст з буфера обміну...")
        ...
        # Вставляємо текст (Ctrl+V)
        pyautogui.hotkey('ctrl', 'v')
        time.sleep(0.1)
        
        print(f"✅ Текст успішно вставлено!")
        print(f"📄 Вставлений текст: {text_to_paste[:100]}..." if len(text_to_paste) > 100 else f"📄 Вставлений текст: {text_to_paste}")
        return True
