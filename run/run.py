...
def main_workflow():
    ...
    # КРОК 2: Клік по знайденій позиції
    print("\n🖱️ КРОК 2: Клікаю по знайденій позиції...")
    if not click_at_position(position):
        print("❌ Не вдалося виконати клік. Завершую роботу.")
        return False
    ...
    # КРОК 3: Копіювання тексту з позиції
    print("\n📋 КРОК 3: Копіюю текст з позиції...")
    copied_text = copy_text_from_position(position[0], position[1])
    
    if not copied_text:
        print("❌ Не вдалося скопіювати текст. Завершую роботу.")
        return False
    ...
    # КРОК 4: Пошук та клік по зображенню хром браузера
    # Змінюємо тільки click_on та click_offset
    settings.click_on = "center"
    settings.click_offset = (0, -3)

    print("\n🔍 КРОК 4: Шукаю зображення 11.png'...")
    ...
    # КРОК 5: Клік по знайденій позиції
    print("\n🖱️ КРОК 5: Клікаю по знайденій позиції...")
    if not click_at_position(position):
        print("❌ Не вдалося виконати клік. Завершую роботу.")
        return False
    ...
    print("\n⏳ Затримка 5 секунд після кроку 5...")
    time.sleep(5)
    ...
    print("\n🔍 КРОК 6: Шукаю зображення 9.png'...")
    position = find_image("9.png", settings)
    ...
    # ======================== КРОК 7  Клік по знайденій позиції
    print("\n🖱️ КРОК 7: Клікаю по знайденій позиції...")
    if not click_at_position(position):
        print("❌ Не вдалося виконати клік. Завершую роботу.")
        return False
    ...
    # =====================  КРОК 8, аштв 12.png
    # Змінюємо тільки click_on та click_offset
    settings.click_on = "right"
    settings.click_offset = (0, 0)

    print("\n🔍 КРОК 6: Шукаю зображення 12.png'...")
    position = find_image("12.png", settings)
    ...
    # ======================== КРОК 9  Клік по знайденій позиції
    print("\n🖱️ КРОК 9: Клікаю по знайденій позиції...")
    if not click_at_position(position):
        print("❌ Не вдалося виконати клік. Завершую роботу.")
        return False
